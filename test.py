...
def ValidateSegmentation(args):
    ...
    if args.file_root == 'LEVIR':
        ...
        # args.file_root = '/home/wyt/data/LEVIR-CD'
    ...
    args.vis_dir = args.file_root + '/Style_vis/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', default='/data/sdu08_lyk/data/logs/LEVIR/ap+AFEM_5e-4_91.64/',
